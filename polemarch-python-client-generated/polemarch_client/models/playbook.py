...
class Playbook(object):
    ...
    @property
    def playbook(self):
        """Gets the playbook of this Playbook.  # noqa: E501


        :return: The playbook of this Playbook.  # noqa: E501
        :rtype: str
        """
    ...
    def playbook(self, playbook):
        """Sets the playbook of this Playbook.


        :param playbook: The playbook of this Playbook.  # noqa: E501
        :type: str
        """
        if playbook is None:
            raise ValueError("Invalid value for `playbook`, must not be `None`")  # noqa: E501
        if playbook is not None and len(playbook) > 256:
            raise ValueError("Invalid value for `playbook`, length must be less than or equal to `256`")  # noqa: E501
