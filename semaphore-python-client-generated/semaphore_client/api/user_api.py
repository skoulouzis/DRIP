...
class UserApi(object):
    ...
    def users_post(self, user, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UserRequest user: (required)
        :return: User
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def users_user_id_password_post(self, user_id, password, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_user_id_password_post_with_http_info(user_id, password, **kwargs)  # noqa: E501
        else:
            (data) = self.users_user_id_password_post_with_http_info(user_id, password, **kwargs)  # noqa: E501
            return data

    def users_user_id_password_post_with_http_info(self, user_id, password, **kwargs):  # noqa: E501
        """Updates user password  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_user_id_password_post_with_http_info(user_id, password, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method users_user_id_password_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `users_user_id_password_post`")  # noqa: E501
        # verify the required parameter 'password' is set
        if ('password' not in params or
                params['password'] is None):
            raise ValueError("Missing the required parameter `password` when calling `users_user_id_password_post`")  # noqa: E501
    ...
    def users_user_id_put(self, user_id, user, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.users_user_id_put_with_http_info(user_id, user, **kwargs)  # noqa: E501
        else:
            (data) = self.users_user_id_put_with_http_info(user_id, user, **kwargs)  # noqa: E501
            return data

    def users_user_id_put_with_http_info(self, user_id, user, **kwargs):  # noqa: E501
        """Updates user details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.users_user_id_put_with_http_info(user_id, user, async_req=True)
        >>> result = thread.get()
        ...
        if ('user' not in params or
                params['user'] is None):
            raise ValueError("Missing the required parameter `user` when calling `users_user_id_put`")  # noqa: E501
